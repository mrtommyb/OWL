...
The expected squared signal-to-noise ratio for $q_n$ is
\begin{eqnarray}
\left[\frac{s}{n}\right]^2 &=& \frac{[\transpose{w}\, \E{y_n}]^2}{\transpose{w}\, \Covar{y_n}\, w}
\quad .
\end{eqnarray}
