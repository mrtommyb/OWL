...
We demonstrate enormous improvement to the \project{Kepler} HOGG!
\end{abstract}
...
\quad ,
\end{eqnarray}
  which is the natural generalization to correlated noise
  of the result (for independent pixel noise)
