...
% - Finish zeroth draft.
% - Send for comments to Lupton, Carey, Wright, Brandner
...
These detrendings are created by filtering or fitting-and-subtracting
  the SAP photometry;
  they remove intrinsic stellar variability and create artificial epoch-to-epoch correlations
  in the photometric noise.
\figurename~\ref{fig:results} shows the the OWL photometry
  (and some variants discussed below).
The OWL photometry very effectively  detrends the data,
  even though it involves \emph{no explicit detrending}.
That is, it is just a soft-aperture aperture photometry, identical from epoch to epoch.
...
\begin{eqnarray}
\Sigma^2 &=& \frac{[\transpose{w}\, \hat{\mu}]^2}{\transpose{w}\, \hat{C}\, w}
\quad ,
\end{eqnarray}
...
\includegraphics[width=\textwidth]{kic_03335426_photometry.png}
 shows the results of the OPW for KIC~3335426,
...
\clearpage
\begin{figure}
\includegraphics[width=\textwidth]{kic_03335426_pixels.png}
\caption{
...
\clearpage
\begin{figure}
\includegraphics[width=\textwidth]{kic_03335426_images_owl.png}
\caption{
...
\clearpage
\begin{figure}
\includegraphics[width=\textwidth]{kic_03335426_images_opwl.png}
\caption{
