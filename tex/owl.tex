...
You can operate the OWL for all $K$ stars.
...
Or you can use all of the pixels in all the patches around all $K$ stars
...
\clearpage
\begin{figure}
\includegraphics[width=\textwidth]{kic_03335426_images.png}
\caption{
